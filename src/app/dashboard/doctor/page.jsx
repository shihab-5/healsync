...
// import { PersonIcon, CalendarIcon, StarIcon } from '@gravity-ui/icons';
...
//   // Replace with actual auth — e.g. from context / localStorage
...
//         {statCards.map(card => (
//           <Card key={card.label} shadow="sm" className={`${card.border} bg-white`}>
//             <CardBody className="flex flex-row items-center gap-4 py-5 px-6">
